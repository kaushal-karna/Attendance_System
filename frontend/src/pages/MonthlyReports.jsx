...
function MonthlyReports() {
  ...
  const exportFile = async (format) => {
    ...
    try {
      ...
      if (format === "csv") {
        await downloadMonthlyReportCSV(
          month,
          employeeId
        )
      } else {
        await downloadMonthlyReportExcel(
          month,
          employeeId
        )
      }
      ...
      setError(
        err.message ||
          `The ${format} file could not be downloaded.`
      )
    } finally {
      setDownloading("")
    }
  ...
  return (
    <div className="page">
      ...
      <div className="page-header">
        ...
        <p>
          View a month of attendance, then download it
          as CSV or Excel.
        </p>
      </div>
